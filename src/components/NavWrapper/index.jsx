...
function MainNav({ onSelectMenu }) {
    return (
        <ul className='space-y-[0.2vw] mobile:space-y-[2vw] border-r pr-[3vw] border-[#d8d8d8] py-5 main-nav tablet:border-none mobile:border-none tablet:pl-[3vw] mobile:pt-[20vw]'>
            <li>
